...
try {
  ...
  // Custom nodes directory doesn't exist or other error - this is fine
  console.info('[dify-patcher] No custom nodes found or error loading custom nodes')
}
